...
# Requer: pip install newspaper4k lxml[html_clean] feedparser requests beautifulsoup4 python-dotenv

import feedparser
from newspaper import Article, Config  # newspaper4k
...
if __name__ == "__main__":
    """Supervisor com limite de tentativas — compatível com GitHub Actions."""
    import traceback
    ...
    for tentativa in range(1, MAX_RETRIES + 1):
        try:
            ...
            print("")
            print("⚠️ Interrompido manualmente. Encerrando.")
            break
        except Exception as e:
            print("")
            print(f"❌ ERRO INESPERADO (tentativa {tentativa}/{MAX_RETRIES}):")
            ...
            if tentativa < MAX_RETRIES:
                print(f"⏳ Aguardando 15s antes de retentar...")
                time.sleep(15)
            else:
                print("❌ Máximo de tentativas atingido. Encerrando com erro.")
                sys.exit(1)
